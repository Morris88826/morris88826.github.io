    ...
    <a-layout-header>
      <a-menu mode="horizontal" :style="{ lineHeight: '64px' }">
        ...
        <router-link :to="{ name: 'about' }">
          <a-menu-item key="8">About</a-menu-item>
        </router-link>
        <router-link :to="{ name: 'publications' }">
          <a-menu-item key="7">Publications</a-menu-item>
        </router-link>
      ...
      <div class="col" style="margin: auto">
        <div>
          ...
          <p style="font-size: 10px">
            <b>Ph.D. Computer Science, Texas A&M University</b>
          </p>
          <p style="font-size: 10px">
            <b>Speech / Audio ML, Voice AI, Healthcare AI</b>
          </p>
          ...
          >
            <MailOutlined />
            <a href="mailto:mtseng@tamu.edu" style="margin-left: 5px"
              >Email</a
            >
          </p>
          <p
